...
class NdkPortsPluginImpl(
    ...
    private val extension = project.extensions.create("ndkPorts", NdkPortsExtension::class.java)
    ...
    private fun createTasks() {
        ...
        val testTasks = project.tasks.withType(AndroidExecutableTestTask::class.java)
