...
make_manifest() {
  echo "<manifest xmlns:android=\"http://schemas.android.com/apk/res/android\" package=\"io.github.ronickg.sodium\" android:versionCode=\"1\" android:versionName=\"1.0\">
